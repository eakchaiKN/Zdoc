...
/* eslint-disable */
	...
	export default {
		...
		components: {
			'CalendarHeader': require('./components/Dashboard/Views/Clinic/Header.vue').default?require('./components/Dashboard/Views/Clinic/Header.vue').default:require('./components/Dashboard/Views/Clinic/Header.vue'),
			'Week': require('./components/Dashboard/Views/Clinic/Week.vue').default?require('./components/Dashboard/Views/Clinic/Week.vue').default:require('./components/Dashboard/Views/Clinic/Week.vue'),
		},
		created () {
			let me = this;
